    ...
    <Accordion.Item value="exposed">
      ...
      <Accordion.Panel styles={panelStyles}>
        <Text size="sm">
          ...
          it with an ufw rule. If you select directly exposed to the internet,
          some services will bind the port on the host machine on localhost, so
          it will not be reachable from the internet, but be accissible to other
          services on that machine itself.
        </Text>
        <SegmentedControl
          value={networkMode}
